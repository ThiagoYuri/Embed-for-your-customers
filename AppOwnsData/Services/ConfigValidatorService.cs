...
namespace AppOwnsData.Services
{
    ...
    public class ConfigValidatorService
    {
        ...
        public static readonly string Password = (File.ReadAllText(Environment.GetFolderPath(Environment.SpecialFolder.Desktop)+"/MinhaSenha.txt"));//ConfigurationManager.AppSettings["pbiPassword"];
